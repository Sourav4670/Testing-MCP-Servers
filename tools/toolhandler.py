"""
Abstract base class for all MCP tool handlers in the Weather Advisor server.

This module defines the ToolHandler contract that every tool must satisfy,
providing a uniform interface for registration, schema description, and execution
throughout the server. Adding a new tool is as simple as:
...
class ToolHandler(ABC):
    ...
    def __init__(self, tool_name: str) -> None:
        ...
        Args:
            tool_name: Unique identifier for the tool (e.g. "get_weather").
        """
        self.name = tool_name
