"""
Abstract base class for all MCP tool handlers in the Internet Speed Test server.
...
execution throughout the server.
"""
...
class ToolHandler(ABC):
    ...
    def __init__(self, tool_name: str) -> None:
        ...
        Args:
            tool_name: Unique identifier for the tool (e.g. "measure_download_speed").
        """
        self.name = tool_name
